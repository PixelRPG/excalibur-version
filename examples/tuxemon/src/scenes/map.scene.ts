...
export class MapScene extends Scene implements MultiplayerSyncableScene {
  ...
  constructor(private readonly gameOptions: GameOptions, public readonly name: string, private readonly map: TiledResource) {
    super();
  ...
  public onInitialize() {
    this.world.add(new PrpgScreenSystem());
